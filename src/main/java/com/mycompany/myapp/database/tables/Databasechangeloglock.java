...
public class Databasechangeloglock extends TableImpl<DatabasechangeloglockRecord> {
     ...
     */
    public final TableField<DatabasechangeloglockRecord, Integer> ID = createField(
        DSL.name("ID"),
     ...
     */
    public final TableField<DatabasechangeloglockRecord, Byte> LOCKED = createField(
        DSL.name("LOCKED"),
     ...
     */
    public final TableField<DatabasechangeloglockRecord, String> LOCKEDBY = createField(
        DSL.name("LOCKEDBY"),
