...
public class Databasechangelog implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.dateexecuted == null) {
            if (other.dateexecuted != null) return false;
        } else if (!this.dateexecuted.equals(other.dateexecuted)) return false;
        if (this.orderexecuted == null) {
            if (other.orderexecuted != null) return false;
        } else if (!this.orderexecuted.equals(other.orderexecuted)) return false;
        if (this.exectype == null) {
            if (other.exectype != null) return false;
        } else if (!this.exectype.equals(other.exectype)) return false;
        if (this.md5sum == null) {
            if (other.md5sum != null) return false;
        } else if (!this.md5sum.equals(other.md5sum)) return false;
        ...
        if (this.liquibase == null) {
            if (other.liquibase != null) return false;
        } else if (!this.liquibase.equals(other.liquibase)) return false;
        if (this.contexts == null) {
            if (other.contexts != null) return false;
        } else if (!this.contexts.equals(other.contexts)) return false;
        if (this.labels == null) {
            if (other.labels != null) return false;
        } else if (!this.labels.equals(other.labels)) return false;
        if (this.deploymentId == null) {
            if (other.deploymentId != null) return false;
        } else if (!this.deploymentId.equals(other.deploymentId)) return false;
        return true;
    }
